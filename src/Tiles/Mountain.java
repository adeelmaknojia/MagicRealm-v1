...
public class Mountain implements Tile, Serializable  {
	
	private String imgPath = "./images/tiles/mountain2.gif";
	private Image img = new ImageIcon(imgPath).getImage();
	
	private String imgPath1 = "./images/tiles2/mountain3.gif";
...
//		img1 = new ImageIcon(imgPath1).getImage();
	...
	public void setClearing() {
		// TODO Auto-generated method stub
		int tileWidthA = (img.getWidth(null)*3)/4;
		//int tileWidthB = img.getWidth(null)/4;
		int tileHeight = ((img.getHeight(null)+8)/2);
		
		clearings[0] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.06)), (int) (tileLocation.y+(tileHeight*0.60))), 1, 'm');
		clearings[1] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.18)), (int) (tileLocation.y+(tileHeight*0.84))), 2, 'm');
		clearings[2] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.25)), (int) (tileLocation.y+(tileHeight*0.60))), 3, 'm');
		clearings[3] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0)), (int) (tileLocation.y+(tileHeight*0.33))), 4, 'm');
		clearings[4] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.33)), (int) (tileLocation.y+(tileHeight*0.34))), 5, 'm');
		clearings[5] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.18)), (int) (tileLocation.y+(tileHeight*0.25))), 6, 'm');
	...
	public void setAdjacentClearings() {
		...
		clearings[4].setAdjacentClearing(clearings[5]);
		clearings[5].setAdjacentClearing(clearings[2]);
		clearings[5].setAdjacentClearing(clearings[4]);
	...
	public void setClearing1() {
		// TODO Auto-generated method stub
		int tileWidthA = (img1.getWidth(null)*3)/4;
		//int tileWidthB = img.getWidth(null)/4;
		int tileHeight = ((img1.getHeight(null)+8)/2);
		
		
		clearings[0] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.27)), (int) (tileLocation.y+(tileHeight*0.60))), 1, 'm');
		clearings[1] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.34)), (int) (tileLocation.y+(tileHeight*0.33))), 2, 'm');
		clearings[2] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.18)), (int) (tileLocation.y+(tileHeight*0.33))), 3, 'm');
		clearings[3] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.18)), (int) (tileLocation.y+(tileHeight*0.84))), 4, 'm');
		clearings[4] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.01)), (int) (tileLocation.y+(tileHeight*0.33))), 5, 'm');
		clearings[5] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.05)), (int) (tileLocation.y+(tileHeight*0.62))), 6, 'm');
