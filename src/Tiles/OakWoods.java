...
public class OakWoods implements Tile, Serializable  {
	private String imgPath = "./images/tiles/oakwoods2.gif";
	private Image img = new ImageIcon(imgPath).getImage();
	
	private String imgPath1 = "./images/tiles2/oakwoods3.gif";
...
//		img1 = new ImageIcon(imgPath1).getImage();
	...
	public void setClearing() {
		...
		clearings[0] = null;
		clearings[1] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.17)), (int) (tileLocation.y+(tileHeight*0.28))), 2, 'w');
		clearings[2] = null;
		clearings[3] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.63)), (int) (tileLocation.y+(tileHeight*0.65))), 4, 'w');
		clearings[4] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.18)), (int) (tileLocation.y+(tileHeight*0.74))), 5, 'w');
		clearings[5] = null;
	...
	public void setClearing1() {
		...
		clearings[0] = null;
		clearings[1] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.48)), (int) (tileLocation.y+(tileHeight*0.25))), 2, 'w');
		clearings[2] = null;
		clearings[3] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.38)), (int) (tileLocation.y+(tileHeight*0.78))), 4, 'w');
		clearings[4] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.02)), (int) (tileLocation.y+(tileHeight*0.50))), 5, 'w');
		clearings[5] = null;
		for(int i = 0; i < clearings.length; i++) {
			if(clearings[i] != null){
				clearings[i].setTileName(name);
