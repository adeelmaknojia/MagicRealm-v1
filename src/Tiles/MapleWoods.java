...
public class MapleWoods implements Tile , Serializable {
	
	private String imgPath = "./images/tiles/maplewoods2.gif";
	private Image img = new ImageIcon(imgPath).getImage();
	
	private String imgPath1 = "./images/tiles2/maplewoods3.gif";
...
//		img1 = new ImageIcon(imgPath1).getImage();
	...
	public void setClearing() {
		...
		clearings[0] = null;
		clearings[1] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.47)), (int) (tileLocation.y+(tileHeight*0.75))), 2, 'w');
		clearings[2] = null;
		clearings[3] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.03)), (int) (tileLocation.y+(tileHeight*0.66))), 4, 'w');
		clearings[4] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.46)), (int) (tileLocation.y+(tileHeight*0.28))), 5, 'w');
		clearings[5] = null;
	...
	public void setClearing1() {
		...
		clearings[0] = null;
		clearings[1] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.05)), (int) (tileLocation.y+(tileHeight*0.49))), 2, 'w');
		clearings[2] = null;
		clearings[3] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.28)), (int) (tileLocation.y+(tileHeight*0.19))), 4, 'w');
		clearings[4] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.47)), (int) (tileLocation.y+(tileHeight*0.71))), 5, 'w');
		clearings[5] = null;
		for(int i = 0; i < clearings.length; i++) {
			if(clearings[i] != null){
				clearings[i].setTileName(name);
