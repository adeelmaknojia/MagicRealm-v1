...
public class LindenWoods implements Tile, Serializable  {
	
	private String imgPath = "./images/tiles/lindenwoods2.gif";
	private Image img = new ImageIcon(imgPath).getImage();
	
	private String imgPath1 = "./images/tiles2/lindenwoods3.gif";
...
//		img1 = new ImageIcon(imgPath1).getImage();
	...
	public void setClearing() {
		...
		clearings[0] = null;
		clearings[1] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.20)), (int) (tileLocation.y+(tileHeight*0.57))), 2, 'w');
		clearings[2] = null;
		clearings[3] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.33)), (int) (tileLocation.y+(tileHeight*0.19))), 4, 'w');
		clearings[4] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.62)), (int) (tileLocation.y+(tileHeight*0.52))), 5, 'w');
		clearings[5] = null;
	...
	public void setClearing1() {
		...
		clearings[0] = null;
		clearings[1] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.45)), (int) (tileLocation.y+(tileHeight*0.43))), 2, 'w');
		clearings[2] = null;
		clearings[3] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.35)), (int) (tileLocation.y+(tileHeight*0.80))), 4, 'w');
		clearings[4] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.05)), (int) (tileLocation.y+(tileHeight*0.51))), 5, 'w');
		clearings[5] = null;
		for(int i = 0; i < clearings.length; i++) {
			if(clearings[i] != null){
				clearings[i].setTileName(name);
