...
public class Caves implements Tile, Serializable {
	
	private String imgPath = "./images/tiles/caves2.gif";
	private Image img = new ImageIcon(imgPath).getImage();
	
	private String imgPath1 = "./images/tiles2/caves3.gif";
...
//		img1 = new ImageIcon(imgPath1).getImage();
	...
	public void setClearing() {
		...
		clearings[0] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.05)), (int) (tileLocation.y+(tileHeight*0.65))), 1, 'c');
		clearings[1] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.33)), (int) (tileLocation.y+(tileHeight*0.19))), 2, 'c');
		clearings[2] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.35)), (int) (tileLocation.y+(tileHeight*0.46))), 3, 'c');
		clearings[3] = new Clearing(new Point((int) (tileLocation.x-(tileWidthA*0.01)), (int) (tileLocation.y+(tileHeight*0.40))), 4, 'c');
		clearings[4] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.63)), (int) (tileLocation.y+(tileHeight*0.34))), 5, 'c');
		clearings[5] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.54)), (int) (tileLocation.y+(tileHeight*0.78))), 6, 'c');
	...
	public void setClearing1() {
		...
		clearings[0] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.69)), (int) (tileLocation.y+(tileHeight*0.35))), 1, 'c');
		clearings[1] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.34)), (int) (tileLocation.y+(tileHeight*0.80))), 2, 'c');
		clearings[2] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.30)), (int) (tileLocation.y+(tileHeight*0.54))), 3, 'c');
		clearings[3] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.68)), (int) (tileLocation.y+(tileHeight*0.60))), 4, 'c');
		clearings[4] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.05)), (int) (tileLocation.y+(tileHeight*0.65))), 5, 'c');
		clearings[5] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.15)), (int) (tileLocation.y+(tileHeight*0.22))), 6, 'c');
		for(int i = 0; i < clearings.length; i++) {
			clearings[i].setTileName(name);
		}
		setAdjacentClearings();
