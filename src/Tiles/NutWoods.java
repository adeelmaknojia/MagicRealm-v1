...
public class NutWoods implements Tile, Serializable  {
	private String imgPath = "./images/tiles/nutwoods1.gif";
	private Image img = new ImageIcon(imgPath).getImage();
	
	private String imgPath1 = "./images/tiles2/nutwoods3.gif";
...
//		img1 = new ImageIcon(imgPath1).getImage();
	...
	public void setClearing() {
		...
		clearings[0] = null;
		clearings[1] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.50)), (int) (tileLocation.y+(tileHeight*0.75))), 2, 'w') ;
		clearings[2] = null;
		clearings[3] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.06)), (int) (tileLocation.y+(tileHeight*0.69))), 4, 'w');
		clearings[4] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.34)), (int) (tileLocation.y+(tileHeight*0.35))), 5, 'w');
		clearings[5] = null;
	...
	public void setClearing1() {
		...
		clearings[0] = null;
		clearings[1] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.65)), (int) (tileLocation.y+(tileHeight*0.49))), 2, 'w') ;
		clearings[2] = null;
		clearings[3] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.36)), (int) (tileLocation.y+(tileHeight*0.80))), 4, 'w');
		clearings[4] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.18)), (int) (tileLocation.y+(tileHeight*0.41))), 5, 'w');
		clearings[5] = null;
		for(int i = 0; i < clearings.length; i++) {
			if(clearings[i] != null){
				clearings[i].setTileName(name);
