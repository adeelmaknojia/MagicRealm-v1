...
public class Ledges implements Tile, Serializable {

	private String imgPath = "./images/tiles/ledges2.gif";
	private Image img = new ImageIcon(imgPath).getImage();
	
	private String imgPath1 = "./images/tiles2/ledges3.gif";
...
//		img1 = new ImageIcon(imgPath1).getImage();
	...
	public void setClearing() {
		...
		clearings[1] = new Clearing(new Point(
				(int) (tileLocation.x + (tileWidthA * 0.05)),
				(int) (tileLocation.y + (tileHeight * 0.33))), 2, 'm');
		clearings[2] = new Clearing(new Point(
				(int) (tileLocation.x + (tileWidthA * 0.30)),
				(int) (tileLocation.y + (tileHeight * 0.17))), 3, 'w');
		clearings[3] = new Clearing(new Point(
				(int) (tileLocation.x + (tileWidthA * 0.32)),
				(int) (tileLocation.y + (tileHeight * 0.50))), 4, 'w');
		clearings[4] = new Clearing(new Point(
				(int) (tileLocation.x + (tileWidthA * 0.25)),
				(int) (tileLocation.y + (tileHeight * 0.80))), 5, 'm');
		clearings[5] = new Clearing(new Point(
				(int) (tileLocation.x + (tileWidthA * 0.76)),
				(int) (tileLocation.y + (tileHeight * 0.50))), 6, 'w');
