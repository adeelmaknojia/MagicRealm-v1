...
public class DarkValley implements Tile, Serializable {

	private String imgPath = "./images/tiles/darkvalley2.gif";
	private Image img = new ImageIcon(imgPath).getImage();
	
	private String imgPath1 = "./images/tiles2/darkvalley3.gif";
...
//		img1 = new ImageIcon(imgPath1).getImage();
	...
	public void setClearing() {
		...
		clearings[0] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.33)), (int) (tileLocation.y+(tileHeight*0.81))), 1, 'w');
		clearings[1] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.63)), (int) (tileLocation.y+(tileHeight*0.66))), 2, 'w');
		clearings[2] = null;
		clearings[3] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.33)), (int) (tileLocation.y+(tileHeight*0.33))), 4, 'w');
		clearings[4] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.03)), (int) (tileLocation.y+(tileHeight*0.66))), 5, 'w');
		clearings[5] = null;
	...
	public void setClearing1() {
		...
		clearings[0] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.02)), (int) (tileLocation.y+(tileHeight*0.33))), 1, 'w');
		clearings[1] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.02)), (int) (tileLocation.y+(tileHeight*0.61))), 2, 'w');
		clearings[2] = null;
		clearings[3] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.49)), (int) (tileLocation.y+(tileHeight*0.57))), 4, 'w');
		clearings[4] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.30)), (int) (tileLocation.y+(tileHeight*0.18))), 5, 'w');
		clearings[5] = null;
		for(int i = 0; i < clearings.length; i++) {
			if(clearings[i] != null){
				clearings[i].setTileName(name);
