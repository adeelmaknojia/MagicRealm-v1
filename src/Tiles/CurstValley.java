...
public class CurstValley implements Tile , Serializable {

	private String imgPath = "./images/tiles/curstvalley1.gif";
	private Image img = new ImageIcon(imgPath).getImage();
	
	private String imgPath1 = "./images/tiles2/curstvalley3.gif";
...
//		img1 = new ImageIcon(imgPath1).getImage();
	...
	public void setClearing() {
		...
		clearings[0] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.32)), (int) (tileLocation.y+(tileHeight*0.19))), 1, 'w');
		clearings[1] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.02)), (int) (tileLocation.y+(tileHeight*0.35))), 2, 'w');
		clearings[2] = null;
		clearings[3] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.33)), (int) (tileLocation.y+(tileHeight*0.66))), 4, 'w');
		clearings[4] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.62)), (int) (tileLocation.y+(tileHeight*0.40))), 5, 'w');
		clearings[5] = null;
	...
	public void setClearing1() {
		...
		clearings[0] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.66)), (int) (tileLocation.y+(tileHeight*0.34))), 1, 'w');
		clearings[1] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.38)), (int) (tileLocation.y+(tileHeight*0.19))), 2, 'w');
		clearings[2] = null;
		clearings[3] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.16)), (int) (tileLocation.y+(tileHeight*0.58))), 4, 'w');
		clearings[4] = new Clearing(new Point((int) (tileLocation.x+(tileWidthA*0.66)), (int) (tileLocation.y+(tileHeight*0.64))), 5, 'w');
		clearings[5] = null;
		for(int i = 0; i < clearings.length; i++) {
			if(clearings[i] != null){
				clearings[i].setTileName(name);
